...
def generate_section():
    ...
    # ----------------------------------------------------------------------------
    if valid_clash:
        random.shuffle(valid_clash)  # 随机打乱 Clash 列表
        print("🔀 已随机打乱 Clash 链接顺序")
    
    if valid_v2ray:
        random.shuffle(valid_v2ray)  # 随机打乱 V2Ray 列表
        print("🔀 已随机打乱 V2Ray 链接顺序")
    # ----------------------------------------------------------------------------
    ...
    # 1. 推荐部分
    # 由于上面已经 shuffle (洗牌) 过了，这里取 [0] 就是随机取一个
